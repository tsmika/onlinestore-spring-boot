...
VALUES ('admin1', '$2a$11$JEtcrXoUjypxNABqjFOUNeq5Vge4iyLK/9AgtEFM4tQuE3xe28UTa', 'ROLE_ADMIN', TRUE),
       ('admin2', '$2a$11$JEtcrXoUjypxNABqjFOUNeq5Vge4iyLK/9AgtEFM4tQuE3xe28UTa', 'ROLE_ADMIN', TRUE),
       ('customer1', '$2a$11$Z1O/klpFowFL6fFBflJlre/wrj73fmhsglEOInaFvTtXBdyxTwFPq', 'ROLE_USER', TRUE),
       ('customer2', '$2a$11$Z1O/klpFowFL6fFBflJlre/wrj73fmhsglEOInaFvTtXBdyxTwFPq', 'ROLE_USER', TRUE);

INSERT INTO PRODUCT(PICTURE, SHORT_DESCRIPTION, DETAIL_DESCRIPTION, PRICE, CREATION_DATE, UPDATE_DATE, CHANGED_BY)
VALUES ('Pic1', 'Short description for product 1', 'Detail description for product 1', 1.11, now() - 1, now() - 1, 1),
